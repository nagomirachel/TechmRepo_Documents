...
[rhel6]
name=RHEL 6 base OS
baseurl=${/home/PN00334894/Desktop/oserepos/rhel-x86_64-server-6}
enabled=1
gpgcheck=0
priority=20
sslverify=false
...
baseurl=${/home/PN00334894/Desktop/oserepos/rhel-x86_64-server-optional-6}
enabled=1
gpgcheck=0
priority=20
sslverify=false
...
def_ose_yum_repo()
{
  ...
  puddle | extra)
    ...
    url="$/home/PN00334894/Desktop/oserepos/${map[$channel]}/x86_64/os/"
    ;;
  cdn | * )
    map=([client_tools]=ose-rhc [infra]=ose-infra [node]=ose-node [jbosseap_cartridge]=ose-jbosseap)
    url="$/home/PN00334894/Desktop/oserepos/${map[$channel]}/2.2/os"
    ;;
  esac
...
[rhscl]
name=rhscl
baseurl=${/home/PN00334894/Desktop/oserepos/rhel-x86_64-server-6-rhscl-1}/rhscl/1/os/
enabled=1
priority=10
gpgcheck=0
exclude= ${CONF_YUM_EXCLUDE_PKGS}
...
{ # add cartridge (or dependency) repo as needed
  local -A url=(
          [jbosseap]="${/home/PN00334894/Desktop/oserepos/rhel-x86_64-server-6-osop-1-jbosseap}/jbeap/6/os"
          [jbossews]="${/home/PN00334894/Desktop/oserepos/jb-ews-2-x86_64-server-6-rpm}/jbews/2/os"
    [fuse_cartridge]="${/home/PN00334894/Desktop/oserepos/rhel-x86_64-server-6-ose-2.2-jbossfuse}/ose-jbossfuse/2.2/os"
     [amq_cartridge]="${/home/PN00334894/Desktop/oserepos/rhel-x86_64-server-6-ose-2.2-jbossamq}/ose-jbossamq/2.2/os"
  )
